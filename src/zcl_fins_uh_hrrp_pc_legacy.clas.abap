class ZCL_FINS_UH_HRRP_PC_LEGACY definition
  public
...
CLASS ZCL_FINS_UH_HRRP_PC_LEGACY IMPLEMENTATION.
...
*          AND n~hryver EQ ( SELECT max( hryver ) from hrrp_directory where hryid = @lt_setkeylist-hryidpattern ).
    ...
    LOOP AT lt_node ASSIGNING FIELD-SYMBOL(<fs_node>).
      ...
      ls_sethier-level = 0.
      lv_setclass = gsetc_profitcenter_setclass.
