class ZCL_FI_E78_AP_TRANS_S4 definition
  public
  final
  create public .
...
public section.
  ...
  class-methods POST_DOCUMENT
    ...
    changing
      !CT_INPUT type ZTT_INPUT_E78 optional .
  class-methods SEND_EMAIL
    importing
      !IT_DATA type ZTT_INPUT_E78 optional
...
CLASS ZCL_FI_E78_AP_TRANS_S4 IMPLEMENTATION.
...
*      SORT lt_lfb1_2 BY bukrs altkn.
    ...
    LOOP AT ct_input ASSIGNING FIELD-SYMBOL(<lfs_input>).
...
*      ls_docheader-comp_code = ls_data-bukrs.
      ...
      CONCATENATE ls_input-hdr_txt '-' 'E78'
...
*      IF sy-subrc IS NOT INITIAL.
        ...
        READ TABLE lt_lfb1_2 INTO DATA(ls_lfb1)
                              WITH KEY lifnr = lv_vendor_1
                                       bukrs = ls_docheader-comp_code
                                     BINARY SEARCH.
*      IF sy-subrc IS NOT INITIAL.
*        READ TABLE lt_lfb1_2 INTO ls_lfb1
...
*// E78 vendor check
*      READ TABLE lt_lfb1_1 INTO ls_lfb1
...
*      IF lv_add NE 'X'.
      APPEND ls_data TO lt_processed_data.
*      ENDIF.
      <lfs_input>-success = ls_data-success.
...
*        ex_subrc = DATA(lv_subrc).
  ...
  METHOD send_email.
    ...
    ls_mail_input-mail_to_tvarvc = 'ZFI_INT0011_E78_EMAIL'.
*  ls_input-mail_cc_tvarvc = 'ZFI_PS_INT0014_CC_EMAIL_ADDR'.
*  ls_input-mail_to_tvarvc = 'kdurai@publicstorage.com'.
    ls_mail_input-mail_subject = 'E78 Telecon AP Transactions'.
    ...
    ls_mail_input-iv_proc_file_name = 'E78 Posted Telecon AP Transactions_' && sy-datum.
    ...
    ls_mail_input-iv_error_file_name = 'E78 Error Telecon AP Transactions_' && sy-datum.
